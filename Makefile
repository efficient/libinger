...
libgotcha.so: private LDFLAGS += libgotcha.o -ldl -lpthread -lgcc_s -lc -lasm -lebl_x86_64
...
globals.o: globals.h config.h error.h goot.h handle.h namespace.h plot.h
